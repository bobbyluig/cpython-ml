...
do
  ...
  do
    ...
    Q_EPSILON_START=0.5 Q_EPSILON_END=0.0001 Q_FENCE_MEMORY=26214400 Q_LEARNING_RATE="$learningRate" \
     ../python3/bin/python3.8 -u Research/programs/q/transaction.py > "Research/data/transaction2_${learningRate}_${i}.txt"

    # Cache program.
    echo "Cache $learningRate $i"
    Q_EPSILON_START=0.5 Q_EPSILON_END=0.00005 Q_FENCE_MEMORY=26214400 Q_LEARNING_RATE="$learningRate" \
     ../python3/bin/python3.8 -u Research/programs/q/cache.py > "Research/data/cache2_${learningRate}_${i}.txt"
    ...
    Q_EPSILON_START=0.5 Q_EPSILON_END=0.00001 Q_FENCE_MEMORY=146800640 Q_LEARNING_RATE="$learningRate" \
     ../python3/bin/python3.8 -u Research/programs/q/server_collect.py > "Research/data/server2_${learningRate}_${i}.txt"
